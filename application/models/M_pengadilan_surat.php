...
class M_pengadilan_surat extends CI_Model 
{
	...
	public function simpan($id_surat_balas)
	{
        ...
        $data = array('id_surat_balas'      => $post['id_surat_balas'],
        			  ...
        			  'id_users_kejaksaan_balas'  => $post['id_users_kejaksaan'],
                      't_6'                 => $t_6['file_name'],
                      't_7'                 => $t_7['file_name'],
                      't_10'                => $t_10['file_name'],
                      'p_29'                => $p_29['file_name'],
	...
	{
		if ($id_surat != NULL) {
			$this->db->select('tbl_balas_surat_kejaksaan.*, tbl_kejaksaan.id_surat as id_surat, tbl_kejaksaan.nama_tersangka as nama_tersangka, tbl_kejaksaan.nama_jpu as nama_jpu, tbl_kejaksaan.tanggal_penahanan as tanggal_penahanan, tbl_kejaksaan.tanggal_pelimpahan_p31 as tanggal_pelimpahan_p31, tbl_kejaksaan.tanggal_pelimpahan_p32 as tanggal_pelimpahan_p32, tbl_users.*');
			$this->db->from('tbl_balas_surat_kejaksaan');
			$this->db->join('tbl_users', 'tbl_users.id = tbl_balas_surat_kejaksaan.id_users_kejaksaan_balas');
