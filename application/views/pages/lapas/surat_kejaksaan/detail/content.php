      		...
      		<div class="box">
        		<div class="box-header">
          			<div class="col-md-12">
		          		...
		          		<P><br>    
		            		<a href="<?= base_url('surat/surat_kejaksaan');?>" class="btn btn-warning btn-xs">
			              					...
			              					<tr>  
			                					...
			                					<td>
			                  						<div class="form-group">
				                    					...
				                    					<p>
				                      						<a href="<?= base_url('unduh/unduh_surat_kejaksaan/'. $data->t_6);?>" class="btn btn-primary btn-xs" onclick="return confirm('Mau download ?')">
			              					...
			              					<tr>  
								                ...
								                <td>
								                	<div class="form-group">
								                    	...
								                    	<p>
								                      		<a href="<?= base_url('unduh/unduh_surat_kejaksaan/'. $data->t_7);?>" class="btn btn-primary btn-xs" onclick="return confirm('Mau download ?')">
								                      			<i class="glyphicon glyphicon-download-alt"></i> 
								                      		</a> <?= $data->t_7;?>
								                    	</p>
								                  	</div>
								            ...
								            <tr>  
			                					...
			                					<td>
			                  						<div class="form-group">
									                    ...
									                    <p>
									                      	<a href="<?= base_url('unduh/unduh_surat_kejaksaan/'. $data->t_10);?>" class="btn btn-primary btn-xs" onclick="return confirm('Mau download ?')">
																<i class="glyphicon glyphicon-download-alt"></i> 
									                    	</a> <?= $data->t_10;?>
									                    </p>
									                </div>
											...
											<tr>
												...
												<td>
													<div class="form-group">
														...
														<p>
															<a href="<?= base_url('unduh/unduh_surat_kejaksaan/'. $data->p_29);?>" class="btn btn-primary btn-xs" onclick="return confirm('Mau download ?')">
																<i class="glyphicon glyphicon-download-alt"></i> 
															</a> <?= $data->p_29;?>
														</p>
													</div>
			              					...
			              					<tr>  
			                					...
			                					<td>
								                	<div class="form-group">
								                    	...
								                    	<p>
								                      		<a href="<?= base_url('unduh/unduh_surat_kejaksaan/'. $data->p_31);?>" class="btn btn-primary btn-xs" onclick="return confirm('Mau download ?')">
								                      			<i class="glyphicon glyphicon-download-alt"></i> 
								                      		</a> <?= $data->p_31;?>
								                    	</p>
								                  	</div>
											...
											<tr>  
												...
												<td>
													<div class="form-group">
														...
														<p>
															<a href="<?= base_url('unduh/unduh_surat_kejaksaan/'. $data->p_32);?>" class="btn btn-primary btn-xs" onclick="return confirm('Mau download ?')">
																<i class="glyphicon glyphicon-download-alt"></i>
															</a> <?= $data->p_32;?>
														</p>
													</div>
			              					...
			              					<tr>  
			                					...
			                					<td>
			                  						<div class="form-group">
														...
														<p>
															<a href="<?= base_url('unduh/unduh_surat_kejaksaan/'. $data->p_42);?>" class="btn btn-primary btn-xs" onclick="return confirm('Mau download ?')">
																<i class="glyphicon glyphicon-download-alt"></i> 
															</a> <?= $data->p_42;?>
														</p>
													</div>
											...
											<tr>  
												...
												<td>
													<div class="form-group">
														...
														<p>
															<a href="<?= base_url('unduh/unduh_surat_kejaksaan/'. $data->p_48);?>" class="btn btn-primary btn-xs" onclick="return confirm('Mau download ?')">
																<i class="glyphicon glyphicon-download-alt"></i> 
															</a> <?= $data->p_48;?>
														</p>
													</div>
													<div class="form-group">
														...
														<p>
															<a href="<?= base_url('unduh/unduh_surat_kejaksaan/'. $data->ba_17);?>" class="btn btn-primary btn-xs" onclick="return confirm('Mau download ?')">
																<i class="glyphicon glyphicon-download-alt"></i> 
															</a> <?= $data->ba_17;?>
														</p>
													</div>
