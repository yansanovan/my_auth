      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <br>
              <a href="<?php echo base_url('lapas/data_jadwal/'.$value->url);?>" class="btn btn-info btn-sm"> 
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>  
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('lapas/unduh/'.$value->file_eksekusi);?>" target="_blank" class="btn btn-success btn-sm"> 
                    ...
                    <td>
                       <a href="<?php echo base_url('ubah_data_lapas/load_eksekusi/'.$value->id_data);?>" class="btn btn-warning btn-sm">
                  ...
                  <!-- Isi putusan & File Isi putusan & tanggal isi putusan-->
                   ...
                   <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('lapas/unduh/'.$value->file_isi_putusan);?>" target="_blank" class="btn btn-success btn-sm"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                    ...
                    <td>
                       <a href="<?php echo base_url('ubah_data_lapas/load_isi_putusan/'. $value->id_data);?>" class="btn btn-warning btn-sm">
                          <span class="glyphicon glyphicon-edit"></span> Ubah File / Lengkapi File
                        </a>  
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('lapas/unduh/'.$value->file_pembebasan_bersyarat);?>" target="_blank" class="btn btn-success btn-sm"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                    ...
                    <td>
                       <a href="<?php echo base_url('ubah_data_lapas/load_pembebasan_bersyarat/'.$value->id_data);?>" class="btn btn-warning btn-sm">
                          <span class="glyphicon glyphicon-edit"></span> Ubah File / Lengkapi File
                        </a>  
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('lapas/unduh/'.$value->file_remisi);?>" target="_blank" class="btn btn-success btn-sm"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                    ...
                    <td>
                       <a href="<?php echo base_url('ubah_data_lapas/load_remisi/'. $value->id_data);?>" class="btn btn-warning btn-sm">
                          <span class="glyphicon glyphicon-edit"></span> Ubah File / Lengkapi File
                        </a>  
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('lapas/unduh/'.$value->file_bebas);?>" target="_blank" class="btn btn-success btn-sm"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                    ...
                    <td>
                       <a href="<?php echo base_url('ubah_data_lapas/load_bebas/'. $value->id_data);?>" class="btn btn-warning btn-sm">
                          <span class="glyphicon glyphicon-edit"></span> Ubah File / Lengkapi File
                        </a>  
                    </td>                                   
                  </tr>
