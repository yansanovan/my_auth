				...
				<div class="box-header"><br>
					...
					<div class="col-md-12">
						<nav class="navbar navbar-light">
							<h3 align="center"><i class="fa fa-envelope" aria-hidden="true"></i> FORM ENTRY </h3><br>
						</nav>
			            <div class="margin" align="center">
			                <div class="btn-group" style="margin-right: 10px;">
			                  	<button type="button" class="btn btn-app bg-blue" style="width: 320px; height: 100px" data-toggle="dropdown">
				                	<span class="badge bg-yellow count" style="font-size: 14px;"></span>
			                  	...
			                  	<ul class="dropdown-menu">
									...
									<li>
									 ...
									 <li>
				                    	<a href="<?= base_url('kepolisian/history');?>"><i class="fa fa-history"></i>  History SPDP</a>
				                    </li>
			                  	</ul>
			                </div>
