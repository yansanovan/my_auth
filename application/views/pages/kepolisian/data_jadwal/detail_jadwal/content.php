      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <br>
              <a href="<?php echo base_url('kepolisian/data_jadwal');?>" class="btn btn-info btn-sm"> 
                <span class="glyphicon glyphicon-arrow-left"></span> Kembali
              </a>
              <a href="<?= base_url('kepolisian/uraian_pasal/'.$value->url);?>" class="btn btn-success btn-sm">
                <span class="glyphicon glyphicon-file"></span></i>Uraian Pasal
              </a>
              <a  href="<?= base_url('kepolisian/cerita_singkat/'.$value->url);?>" class="btn btn-warning btn-sm">
                <span class="glyphicon glyphicon-file"></span></i>Cerita Singkat
              </a>
            <?php 
            } 
            ?>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('kepolisian/unduh/'.$value->file_penangkapan);?>" class="btn btn-success btn-sm"> 
                    ...
                    <td>
                       <a href="<?php echo base_url('ubah_data_kepolisian/index/'. $value->id_data);?>" class="btn btn-warning btn-sm">
                   ...
                   <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('kepolisian/unduh/'.$value->file_ijin_sita);?>" target="_blank" class="btn btn-success btn-sm"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                    ...
                    <td>
                       <a href="<?php echo base_url('ubah_data_kepolisian/load_ijin_sita/'. $value->id_data);?>" class="btn btn-warning btn-sm">
                          <span class="glyphicon glyphicon-edit"></span> Ubah File / Lengkapi File
                        </a>  
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('kepolisian/unduh/'.$value->file_ijin_geledah);?>" target="_blank" class="btn btn-success btn-sm"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                    ...
                    <td>
                       <a href="<?php echo base_url('ubah_data_kepolisian/load_ijin_geledah/'. $value->id_data);?>" class="btn btn-warning btn-sm">
                          <span class="glyphicon glyphicon-edit"></span> Ubah File / Lengkapi File
                        </a>  
                    </td>
                  ...
                  <tr>
                   ...
                   <td style ="<?php if($value->deskripsi == null){echo 'background-color:red'; }else{echo ''; }?>">
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('kepolisian/unduh/'.$value->file_pelimpahan);?>" target="_blank" class="btn btn-success btn-sm"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                    ...
                    <td>
                       <a href="<?php echo base_url('ubah_data_kepolisian/load_pelimpahan/'. $value->id_data);?>" class="btn btn-warning btn-sm">
                          <span class="glyphicon glyphicon-edit"></span> Ubah File / Lengkapi File
                        </a>  
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('kepolisian/unduh/'.$value->file_penahanan);?>" target="_blank" class="btn btn-success btn-sm"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                    ...
                    <td>
                       <a href="<?php echo base_url('ubah_data_kepolisian/load_penahanan/'. $value->id_data);?>" class="btn btn-warning btn-sm">
                          <span class="glyphicon glyphicon-edit"></span> Ubah File / Lengkapi File
                        </a>  
                    </td>                
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('kepolisian/unduh/'.$value->file_perpanjang_penahanan);?>" target="_blank" class="btn btn-success btn-sm"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                    ...
                    <td>
                       <a href="<?php echo base_url('ubah_data_kepolisian/load_perpanjang_penahanan/'. $value->id_data);?>" class="btn btn-warning btn-sm">
                          <span class="glyphicon glyphicon-edit"></span> Ubah File / Lengkapi File
                        </a>  
                    </td>
