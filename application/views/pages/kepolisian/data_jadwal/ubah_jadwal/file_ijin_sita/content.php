			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header"><br>
			            ...
			            <?= $this->session->flashdata('tanggal_ijin_sita_diubah');?>

						<?= validation_errors();?>
			            <?= $this->session->flashdata('berhasil_diubah');?>
			            
						<?=  form_open_multipart('ubah_data_kepolisian/update_file_ijin_sita');?>
						<div class="col-md-12">
							...
							<div class="col-md-3"><br>
								<div class="form-group">
									...
									<select name="ijin_sita" class="form-control">
									  ...
									  <option value="Ijin Sita" selected="ijin_sita">Ijin Sita</option>
							...
							<div class="col-md-3"><br>
								<div class="form-group">
									<label for="exampleInputEmail1">Pilih File Ijin sita</label>
