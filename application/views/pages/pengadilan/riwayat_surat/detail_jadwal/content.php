      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
             ...
             <?php 
              ...
              ?>
                <tbody>
                    <tr>
                        <td>Status Data</td><td>:</td><td><?php if ($value->file_pelimpahan_berkas == null OR $value->file_penetapan_hari_sidang == null OR $value->file_penahanan == null OR $value->file_penahanan == null OR $value->file_perpanjang_penahanan_I == null OR $value->file_perpanjang_penahanan_II == null OR $value->file_perpanjang_penahanan_III == null) 
                        {
                        ?>
            ...
            <br>
              <a href="<?php echo base_url('pengadilan/data_jadwal/'.$value->url);?>" class="btn btn-info btn-sm"> 
                <span class="glyphicon glyphicon-arrow-left"></span> Kembali
              </a>

              <a href="<?= base_url('pengadilan/uraian_pokok/'.$value->url);?>" class="btn btn-success btn-sm">
                <span class="glyphicon glyphicon-file"></span></i>uraian pokok
              </a>
              <a  href="<?= base_url('pengadilan/putusan_amar/'.$value->url);?>" class="btn btn-warning btn-sm">
                <span class="glyphicon glyphicon-file"></span></i>putusan amar
              </a>
            <?php 
            } 
            ?>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>  
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('pengadilan/unduh/'.$value->file_pelimpahan_berkas);?>" target="_blank" class="btn btn-success btn-sm"  onclick="return confirm('Mau Download?')"> 
                    ...
                    <td>
                       <a href="<?php echo base_url('ubah_data_pengadilan/load_pelimpahan_berkas/'.$value->id_data);?>" class="btn btn-warning btn-sm">
                  ...
                  <!-- Penetapan hari sidang-->
                   ...
                   <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('pengadilan/unduh/'.$value->file_penetapan_hari_sidang);?>" target="_blank" class="btn btn-success btn-sm"  onclick="return confirm('Mau Download?')"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                    ...
                    <td>
                       <a href="<?php echo base_url('ubah_data_pengadilan/load_penetapan_hari_sidang/'. $value->id_data);?>" class="btn btn-warning btn-sm">
                          <span class="glyphicon glyphicon-edit"></span> Ubah File / Lengkapi File
                        </a>  
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('pengadilan/unduh/'.$value->file_penahanan);?>" target="_blank" class="btn btn-success btn-sm"  onclick="return confirm('Mau Download?')"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                    ...
                    <td>
                       <a href="<?php echo base_url('ubah_data_pengadilan/load_penahanan/'.$value->id_data);?>" class="btn btn-warning btn-sm">
                          <span class="glyphicon glyphicon-edit"></span> Ubah File / Lengkapi File
                        </a>  
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('pengadilan/unduh/'.$value->file_perpanjang_penahanan_I);?>" target="_blank" class="btn btn-success btn-sm"  onclick="return confirm('Mau Download?')"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                    ...
                    <td>
                       <a href="<?php echo base_url('ubah_data_pengadilan/load_perpanjang_penahanan_I/'. $value->id_data);?>" class="btn btn-warning btn-sm">
                          <span class="glyphicon glyphicon-edit"></span> Ubah File / Lengkapi File
                        </a>  
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('pengadilan/unduh/'.$value->file_perpanjang_penahanan_II);?>" target="_blank" class="btn btn-success btn-sm"  onclick="return confirm('Mau Download?')"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                    ...
                    <td>
                       <a href="<?php echo base_url('ubah_data_pengadilan/load_perpanjang_penahanan_II/'. $value->id_data);?>" class="btn btn-warning btn-sm">
                          <span class="glyphicon glyphicon-edit"></span> Ubah File / Lengkapi File
                        </a>  
                    </td>                                   
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('pengadilan/unduh/'.$value->file_perpanjang_penahanan_III);?>" target="_blank" class="btn btn-success btn-sm"  onclick="return confirm('Mau Download?')"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                    ...
                    <td>
                       <a href="<?php echo base_url('ubah_data_pengadilan/load_perpanjang_penahanan_III/'.$value->id_data);?>" class="btn btn-warning btn-sm">
                          <span class="glyphicon glyphicon-edit"></span> Ubah File / Lengkapi File
                        </a>  
                    </td> 
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('pengadilan/unduh/'.$value->file_putusan);?>" target="_blank" class="btn btn-success btn-sm"  onclick="return confirm('Mau Download?')"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                    ...
                    <td>
                       <a href="<?php echo base_url('ubah_data_pengadilan/load_putusan/'.$value->id_data);?>" class="btn btn-warning btn-sm">
                          <span class="glyphicon glyphicon-edit"></span> Ubah File / Lengkapi File
                        </a>  
                    </td> 
                  </tr>
