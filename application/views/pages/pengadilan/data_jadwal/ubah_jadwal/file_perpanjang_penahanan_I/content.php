<div class="content-wrapper" style="min-height: 460px;">
	<section class="content-header">
		<h1>Ubah Jadwal Perpanjang Penahanan I</h1>
	</section>
			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header"><br>
						...
						<?=  form_open_multipart('ubah_data_pengadilan/update_file_perpanjang_penahanan_I');?>
						<div class="col-md-12">
							...
							<div class="col-md-3"><br>
								<div class="form-group">
									...
									<input type="date" name="tanggal_perpanjang_penahanan_I" value="<?= $data->tanggal_perpanjang_penahanan_I;?>" class="form-control" id="exampleInputEmail1" placeholder="pilih file">
								</div>
							</div>
