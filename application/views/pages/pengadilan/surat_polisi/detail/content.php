        ...
        <div class="box-header">
          ...
          <table class="table table-bordered">
           <!-- <table id="example1" class="table table-bordered table-striped"> -->
            <thead>
              <tr>
                <th class="col-sm-6">Nama File</th>
                <th class="col-sm-6">Lampiran</th>
              </tr>
            </thead>
            <tbody>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <div class="form-group">
                      ...
                      <p>
                        <a href="<?= base_url('kejaksaan/unduh/'.$value->spdp);?>" class="btn btn-primary btn-sm"><i class="glyphicon glyphicon-download-alt"></i> 
                        </a> <?= $value->spdp ;?></p>
                  </div>
                </td>
              </tr>
