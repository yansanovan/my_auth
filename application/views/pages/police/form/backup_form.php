                        ...
                        <div class="col-md-12">
                            ...
                            <!-- <div class="col-lg-4 col-xs-8"> -->
                              ...
                              <div class="small-box bg-blue" >
                                <div class="inner" >
                                  <h4 align="center"  data-toggle="dropdown"> <i class="fa fa-envelope"></i> SPDP</h4>

                                  <ul class="dropdown-menu">
                                    <li>
                                      <a href="#" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-edit"></i>  Input SPDP
                                      </a>
                                    </li>
                                    <li>
                                      <a href="#" data-toggle="modal" data-target="#modal-spdp_masuk" class="polisi">
                            ...
                            <!-- <div class="col-lg-4 col-xs-8"> -->
                              ...
                              <div class="small-box bg-green" >
                                <div class="inner" >
                                  <h4 align="center"  data-toggle="dropdown"> <i class="fa fa-envelope"></i> Perpanjangan Penahanan</h4>

                                  <ul class="dropdown-menu">
                                    <li>
                                      <a href="#" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-edit"></i>  Input Perpanjangan Penahanan
                                      </a>
                                    </li>
                                    <li>
                                      <a href="#" data-toggle="modal" data-target="#modal-spdp_masuk" class="polisi">
                            ...
                            <!-- <div class="col-lg-12"> -->
                              ...
                              <div class="small-box bg-red" >
                                <div class="inner" >
                                  <h4 align="center"  data-toggle="dropdown"> 
                                    <i class="fa fa-envelope"></i> Pemberitahuan pengiriman tersangka & Barbuk
                                  </h4>
                                  <ul class="dropdown-menu">
                                    <li>
                                      <a href="#" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-edit"></i>  Input Perpanjangan Penahanan
                            ...
                            <!-- <div class="col-lg-12"> -->
                              ...
                              <div class="small-box bg-yellow" >
                                <div class="inner" >
                                  <h4 align="center"  data-toggle="dropdown"> 
                                    <i class="fa fa-envelope"></i> Pengiriman Berkas
                                  </h4>
                                  <ul class="dropdown-menu">
                                    <li>
                                      <a href="#" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-edit"></i>  Input Perpanjangan Penahanan
                      ...
                      <!--      <div class="input-group input-group-lg">
                              <div class="input-group-btn">
                                <button type="button" class="btn btn-warning" data-toggle="dropdown" aria-expanded="false">
                                  <i class="fa fa-envelope"></i> SPDP <span class="label label-danger count"></span> 
                                </button>
                                <ul class="dropdown-menu">
                                  <li>
                                    <a href="#" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-edit"></i>  Input SPDP
