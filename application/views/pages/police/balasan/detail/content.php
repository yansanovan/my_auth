                            ...
                            <div class="panel-body">
                                <table  width="350px">
                                    <tbody>
                                        ...
                                        <tr>
                                            <?php $date = date('d-m-Y', strtotime($value->tanggal_balas_kj));?> 
                                            ...
                                            { 
                                                echo  date('d-m-Y', strtotime($value->tanggal_balas_kj));?>     
                                            <?php 
                                            } 
                                            ?>
                                        ...
                                        <tr>
                                            ...
                                            <td width="100px"> 
                                            <?php 
                                            $date_balasan_pn = date('d-m-Y', strtotime($value->tanggal_balas_pn)); 
                                            if ($date_balasan_pn == '01-01-1970') 
                                            { 
                                                echo '';?>
                                            <?php 
                                            } 
                                            ...
                                            { 
                                                echo  date('d-m-Y', strtotime($value->tanggal_balas_pn));?>     
                                            <?php 
                                            } 
                                            ?>
                                            </td>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr bgcolor="#8e8d8d">
                                            ...
                                            <th class="col-sm-7" style="color: white">
                                                <i class="fa fa-book" aria-hidden="true"></i> Lampiran
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
