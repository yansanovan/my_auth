	...
	<div class="row">
		...
		<div class="col-lg-3 col-xs-6">
			...
			<div class="small-box bg-blue">
				...
				<a href="<?= base_url('pengadilan');?>" class="small-box-footer">Lihat <i class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div>
		...
		<div class="col-lg-3 col-xs-6">
			...
			<div class="small-box bg-aqua">
				<div class="inner">
					<h3>Total : <?= $surat_polisi_dibalas;?></h3>

					<p><?= $surat_balasan_ke_polisi;?></p>
				</div>
				<div class="icon">
					<i class="ion ion-stats-bars"></i>
				</div>
				<a href="<?= base_url('pengadilan/riwayat_balas');?>" class="small-box-footer">Lihat <i class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div>
		...
		<div class="col-lg-3 col-xs-6">
			...
			<div class="small-box bg-purple">
				...
				<a href="<?= base_url('pengadilan_surat');?>" class="small-box-footer">Lihat <i class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div>
		<!-- ./col -->
		<div class="col-lg-3 col-xs-6">
			...
			<div class="small-box bg-green">
				<div class="inner">
					<h3>Total : <?= $surat_kejaksaan_dibalas;?></h3>

					<p><?= $surat_balasan_ke_kejaksaan;?></p>
				</div>
				<div class="icon">
					<i class="ion ion-stats-bars"></i>
				</div>
				<a href="<?= base_url('pengadilan_surat/riwayat_balas');?>" class="small-box-footer">Lihat <i class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div>
		<!-- ./col -->
		<div class="col-lg-3 col-xs-6">
