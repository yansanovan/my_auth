<div class="content-wrapper" style="min-height: 460px;">
	<section class="content-header">
		<h1>Ubah Data Jadwal Tahap I</h1>
	</section>
			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header"><br>
						...
						<?=  form_open_multipart('ubah_data_kejaksaan/update_file_tahap_I');?>
						<div class="col-md-12">
							...
							<div class="col-md-3"><br>
								...
								<input type="text" name="file_tahap_I_lama" value="<?= $data->file_tahap_I;?>"  class="form-control">
								</div>
							</div>
							<div class="col-md-3"><br>
								<div class="form-group">
									<label for="exampleInputEmail1">Pilih File Tahap I</label>
							...
							<div class="col-md-3"><br>
								<div class="form-group">
									...
									<input type="date" name="tanggal_tahap_I" value="<?= $data->tanggal_tahap_I;?>" class="form-control" id="exampleInputEmail1" placeholder="pilih file">
								</div>
							</div>
