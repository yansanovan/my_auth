                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>  
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('kejaksaan/unduh/'.$value->file_pelimpahan_berkas);?>" target="_blank" class="btn btn-success btn-sm"> 
                  ...
                  <!-- Tahap I & file Tahap I & tanggal Tahap I-->
                   ...
                   <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('kejaksaan/unduh/'.$value->file_tahap_I);?>" target="_blank" class="btn btn-success btn-sm"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('kejaksaan/unduh/'.$value->file_tahap_II);?>" target="_blank" class="btn btn-success btn-sm"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('kejaksaan/unduh/'.$value->file_pelimpahan);?>" target="_blank" class="btn btn-success btn-sm"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('kejaksaan/unduh/'.$value->file_penahanan);?>" target="_blank" class="btn btn-success btn-sm"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('kejaksaan/unduh/'.$value->file_perpanjang_penahanan);?>" target="_blank" class="btn btn-success btn-sm"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                  ...
                  <!-- eksekusi putusan & file eksekusi putusan & tanggal eksekusi putusan-->
                   ...
                   <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('kejaksaan/unduh/'.$value->file_eksekusi_putusan);?>" target="_blank" class="btn btn-success btn-sm"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
