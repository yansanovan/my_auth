                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>  
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('kejaksaan/unduh_lapas/'.$value->file_eksekusi);?>" target="_blank" class="btn btn-success btn-sm"> 
                  ...
                  <!-- Isi putusan & File Isi putusan & tanggal isi putusan-->
                   ...
                   <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('kejaksaan/unduh_lapas/'.$value->file_isi_putusan);?>" target="_blank" class="btn btn-success btn-sm"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('kejaksaan/unduh_lapas/'.$value->file_pembebasan_bersyarat);?>" target="_blank" class="btn btn-success btn-sm"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('kejaksaan/unduh_lapas/'.$value->file_remisi);?>" target="_blank" class="btn btn-success btn-sm"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {
                      ?>
                        <a href="<?php echo base_url('kejaksaan/unduh_lapas/'.$value->file_bebas);?>" target="_blank" class="btn btn-success btn-sm"> 
                          <span class="glyphicon glyphicon-eye-open"></span> Download
                        </a>
                      <?php 
                      }
