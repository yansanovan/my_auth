				...
				<div class="box-body">
					<div class="table-responsive">
						<table id="example1" class="table table-bordered table-striped">
							...
							<tr>
								<td><?= $no++;?></td>
								<td><?= $value->perpanjangan_penahanan;?></td>
								<td><?= $value->file_perpanjangan_penahanan;?></td>
								<td><?= date('d-m-Y H:i:s', strtotime($value->date));?></td>
								<td>
									<a href="#" data-toggle="modal" data-target="#modal_reply_spdp" data-whatever="@mdo" class="btn btn-danger btn-xs reply_spdp"> 
										<i class="fa fa-unlock" aria-hidden="true"></i> Reply
									</a>
								</td>
							</tr>           
							<?php endforeach; ?>
