      		...
      		<div class="box">
        		<div class="box-header">
          			<div class="col-md-12">
		          		...
		          		<P><br>    
		            		<a href="<?= base_url('kejaksaan_surat');?>" class="btn btn-warning btn-xs">
		               			<i class="fa fa-long-arrow-left" aria-hidden="true"></i>  Kembali
		            		</a>
            				<div class="panel panel-info">
							  	<div class="panel-heading">
							  		<h3 align="center" style="color: black"><i class="fa fa-envelope" aria-hidden="true"></i> DETAIL SURAT PENGADILAN </h3><br>
							  	</div>
		              					...
		              					<tr>  
		                					...
		                					<td>
		                  						<div class="form-group">
			                    					...
			                    					<p>
			                      						<a href="<?= base_url('kejaksaan_surat/download/'.$data->t_6);?>" class="btn btn-primary btn-xs">
		              					...
		              					<tr>  
							                ...
							                <td>
							                	<div class="form-group">
							                    	...
							                    	<p>
							                      		<a href="<?= base_url('kejaksaan_surat/download/'.$data->t_7);?>" class="btn btn-primary btn-xs">
							                      			<i class="glyphicon glyphicon-download-alt"></i> 
							                      		</a> <?= $data->t_7;?>
							                    	</p>
							                  	</div>
							            ...
							            <tr>  
		                					...
		                					<td>
		                  						<div class="form-group">
								                    ...
								                    <p>
								                      	<a href="<?= base_url('kejaksaan_surat/download/'.$data->t_10);?>" class="btn btn-primary btn-xs">
															<i class="glyphicon glyphicon-download-alt"></i> 
								                    	</a> <?= $data->t_10;?>
								                    </p>
								                </div>
										...
										<tr>
											...
											<td>
												<div class="form-group">
													...
													<p>
														<a href="<?= base_url('kejaksaan_surat/download/'.$data->p_29);?>" class="btn btn-primary btn-xs">
															<i class="glyphicon glyphicon-download-alt"></i> 
														</a> <?= $data->p_29;?>
													</p>
												</div>
		              					...
		              					<tr>  
		                					...
		                					<td>
							                	<div class="form-group">
							                    	...
							                    	<p>
							                      		<a href="<?= base_url('kejaksaan_surat/download/'.$data->p_31);?>" class="btn btn-primary btn-xs">
							                      			<i class="glyphicon glyphicon-download-alt"></i> 
							                      		</a> <?= $data->p_31;?>
							                    	</p>
							                  	</div>
										...
										<tr>  
											...
											<td>
												<div class="form-group">
													...
													<p>
														<a href="<?= base_url('kejaksaan_surat/download/'.$data->p_32);?>" class="btn btn-primary btn-xs">
															<i class="glyphicon glyphicon-download-alt"></i>
														</a> <?= $data->p_32;?>
													</p>
												</div>
		              					...
		              					<tr>  
		                					...
		                					<td>
		                  						<div class="form-group">
													...
													<p>
														<a href="<?= base_url('kejaksaan_surat/download/'.$data->p_42);?>" class="btn btn-primary btn-xs">
															<i class="glyphicon glyphicon-download-alt"></i> 
														</a> <?= $data->p_42;?>
													</p>
												</div>
										...
										<tr>  
											...
											<td>
												<div class="form-group">
													...
													<p>
														<a href="<?= base_url('kejaksaan_surat/download/'.$data->p_48);?>" class="btn btn-primary btn-xs">
															<i class="glyphicon glyphicon-download-alt"></i> 
														</a> <?= $data->p_48;?>
													</p>
												</div>
												<div class="form-group">
													...
													<p>
														<a href="<?= base_url('kejaksaan_surat/download/'.$data->ba_17);?>" class="btn btn-primary btn-xs">
															<i class="glyphicon glyphicon-download-alt"></i> 
														</a> <?= $data->ba_17;?>
													</p>
												</div>
